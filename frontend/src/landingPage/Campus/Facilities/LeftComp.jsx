...
function LeftComp({ LeftTitle, Desc, imgSrc,btnText,hrefLink }) {
    return (
        <ScrollAnimate>
            <div className="container p-4" id='GoalBox'>
                <div className="row p-3">
                    <div className="col-6 p-3">
                        <img src={imgSrc} className='text-center border border-5 border-secondary-subtle' alt="imageUrl" style={{ width: '100%' }} />
                    </div>
                    <div className="col-1 p-2"></div>
                    <div className="col-5 p-3">
                        <h1 className=' fw-bolder' style={{ fontSize: '3.5rem' }}>{LeftTitle}</h1>
